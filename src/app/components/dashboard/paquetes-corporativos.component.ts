...
@Component({
  selector: 'app-dashboard-paquetes-corporativos',
  standalone: true,
  ...
  template: `
    <div class="dashboard-content">
      <div class="dashboard-header">
        ...
        <p class="dashboard-subtitle">Encuentra el paquete perfecto para tu evento empresarial</p>
      </div>
...
export class PaquetesCorporativosComponent implements OnInit {
  paquetes: any[] = [];
