...
@Component({
  selector: 'app-dashboard-busqueda-habitaciones',
  standalone: true,
...
export class DashboardBusquedaHabitacionesComponent implements OnInit {
  // Constantes
  ...
  reservar(habitacion: HabitacionResultado): void {
    ...
    // Navegar a la página de reserva con los parámetros
    // Manteniéndolo dentro del contexto del dashboard
    this.router.navigate(['/dashboard/reservar', habitacion._id], {
      queryParams: {
        fechaInicio: this.filtros.fechaInicio,
        fechaFin: this.filtros.fechaFin,
        huespedes: this.filtros.huespedes,
        fromDashboard: true,
        returnUrl: '/dashboard/busqueda-habitaciones'
      }
    });
  }

  /**
   * Ver detalles de habitación conservando filtros
   */
  verDetalles(habitacion: HabitacionResultado): void {
    // Navegar al detalle manteniendo el contexto del dashboard
    this.router.navigate(['/dashboard/habitacion', habitacion._id], {
      queryParams: {
        fechaInicio: this.filtros.fechaInicio,
        fechaFin: this.filtros.fechaFin,
        huespedes: this.filtros.huespedes,
  ...
  /**
   * Cargar filtros guardados en sessionStorage
   */
  ...
  /**
   * Toggle servicio (marcar/desmarcar)
   */
  ...
  /**
   * Aplicar filtros de servicios (re-ejecutar búsqueda)
   */
